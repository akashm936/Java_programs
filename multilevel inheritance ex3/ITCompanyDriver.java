...
class TechMahindra extends ITCompany
{
	...
	public void displayTechMahindra(){
		...
		System.out.println("Company valueation : "+this.valueation+"billion doller");
...
class TCS extends ITCompany
{
    ...
    TCS(String tcs_emp,double tcs_val,String tcs_add,String tcs_hiring,String name, String location){
    ...
    public void displayTCS(){
    	...
    	System.out.println("Company valueation : "+this.tcs_val+"billion doller");
...
class ITCompanyDriver
{
	public static void main(String[] args) {
		...
		TechMahindra obj1 = new TechMahindra("1000000",150,"deccan Gymkhana",true,"TechMahindra","Pune");
	    obj1.displayTechMahindra();

	    TechMahindra obj2 = new TechMahindra("500000",250,"Hinjewadi",true,"TATA Consultance Services","Pune");
	    obj2.displayTechMahindra();
	}
}